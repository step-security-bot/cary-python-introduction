...
## Some topics I'll be considering in stepwise order
...
- Now paint me a picture with the data. (introduction to [Holoviz Ecosystem](https://holoviz.org/index.html))
- How do I share this?
